...
struct ForecastView: View {
    ...
    var body: some View {
        ...
        .backgroundBlur(radius: 25, opaque: true)
            ...
            .innerShadow(shape: RoundedRectangle(cornerRadius: 44), color: Color.bottomSheetBorderMiddle,lineWidth: 1 , offsetX: 0 ,offsetY: 1 , blur: 0 , blendMode: .overlay,opcity: 1 - bottomSheetTranslationProrated)
            .overlay {
